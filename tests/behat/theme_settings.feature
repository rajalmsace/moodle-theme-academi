@theme @theme_academi @javascript @_file_upload
...
In order to use the features
  ...
  Scenario: Setting: Replace logo and add Favicon
    ...
    #     | s_theme_academi_slide1btntarget | Same window |
    #     | s_theme_academi_slide1contFullwidth | 70 |
    # And I select "TopRight" from the "Content position" singleselect
    # And I press "Save changes"
    # And I am on site homepage
    # And I should see "Slider 1" in the ".homepage-carousel .heading-content h1" "css_element"
    # And I should see "Button 1" in the ".homepage-carousel .heading-content .link-button a" "css_element"
  ...
  Scenario: Setting: General
    ...
    And I upload "theme/academi/tests/fixtures/logo.png" file to "Logo" filemanager
    And I press "Save changes"
    ...
    And I press "Save changes"
    And I am on site homepage
    And I should see "" in the ".homepage-carousel .heading-content h1" "css_element"
    Then "//div[contains(@class, 'header-main')]//img[contains(@src, 'pluginfile.php/1/theme_academi/logo/')][contains(@src, 'logo.png')]" "xpath_element" should exist
  ...
  Scenario: Setting: Jumbotron
    ...
    # | s_theme_academi_mspotstatus  |  0  |
      ...
      | s_theme_academi_jumbotronbtntarget |  Same window      |
    And I press "Save changes"

  Scenario: Setting: Footer
    Given I am on site homepage
    And I navigate to theme settings page
